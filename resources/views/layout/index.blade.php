...
<body>
  ...
  <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3 bg-primary" id="mainNav">
    <div class="container"><a class="navbar-brand d-flex align-items-center text-white" href="/"><img class="img-fluid p-1" src="assets/img/brands/34322.png" style="width: 30px;"><span>EverywhereBooks</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
